...
<div class="ocdi  wrap  about-wrap">
	...
	<?php ob_start(); ?>
		<h1 class="ocdi__title  dashicons-before  dashicons-upload"><?php esc_html_e( 'Di Themes : One Click Demo Import', 'pt-ocdi' ); ?></h1>
	<?php
	...
	<div class="ocdi__intro-notice  notice  notice-warning  is-dismissible">
		<p><?php esc_html_e( 'Before you begin, make sure all the theme recommended plugins (Appearance > Install Plugins) are activated.', 'pt-ocdi' ); ?></p>
	</div>
