...
function variant_page_builder_load_scripts(){   
	...
	wp_enqueue_script('jquery', VARIANT_PAGE_BUILDER_PATH .'js/jquery.js', false, VARIANT_PAGE_BUILDER_VERSION, true );
	wp_enqueue_script('variant-underscore', VARIANT_PAGE_BUILDER_PATH .'js/underscore.min.js', array('jquery'), VARIANT_PAGE_BUILDER_VERSION, true );
	wp_enqueue_script('variant-alter-class', VARIANT_PAGE_BUILDER_PATH .'js/alterClass.js', array('jquery'), VARIANT_PAGE_BUILDER_VERSION, true );
	wp_enqueue_script('variant-jQuery-ui', VARIANT_PAGE_BUILDER_PATH .'js/jquery-ui-1.10.4.custom.min.js', array('jquery'), VARIANT_PAGE_BUILDER_VERSION, true );
	wp_enqueue_script('variant-storage2', VARIANT_PAGE_BUILDER_PATH .'js/storage2.js', array('jquery'), VARIANT_PAGE_BUILDER_VERSION, true );
	wp_enqueue_script('variant-simple-modal', VARIANT_PAGE_BUILDER_PATH .'js/simpleModal.js', array('jquery'), VARIANT_PAGE_BUILDER_VERSION, true );
	wp_enqueue_script('variant-he', VARIANT_PAGE_BUILDER_PATH .'js/he.js', array('jquery'), VARIANT_PAGE_BUILDER_VERSION, true );
	wp_enqueue_script('variant-html-beautify', VARIANT_PAGE_BUILDER_PATH .'js/htmlBeautify.js', array('jquery'), VARIANT_PAGE_BUILDER_VERSION, true );
	wp_enqueue_script('variant-medium-editor', VARIANT_PAGE_BUILDER_PATH .'js/mediumEditor.min.js', array('jquery'), VARIANT_PAGE_BUILDER_VERSION, true );
	wp_enqueue_script('variant-variant', VARIANT_PAGE_BUILDER_PATH .'js/variant.js', array('jquery'), VARIANT_PAGE_BUILDER_VERSION, true );
	wp_enqueue_script('variant-variant-wp', VARIANT_PAGE_BUILDER_PATH .'js/variant_wp.js', array('jquery'), VARIANT_PAGE_BUILDER_VERSION, true );
	wp_enqueue_script('variant-wp-shortcode-options', esc_url(trailingslashit( get_template_directory_uri() )) .'variant_config/shortcode_options.js', array('jquery'), VARIANT_PAGE_BUILDER_VERSION, true );
	wp_enqueue_media();
